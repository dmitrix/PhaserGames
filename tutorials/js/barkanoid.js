...
function phaserCreate(){
  ...
  tiles.physicsBodyType = Phaser.Physicis.ARCADE;
  ...
  ball.event.onOutOfBounds.add(helpers.death, this);
}
...
function phaserUpdate(){
  ...
  if (ballOnPaddle){
    ...
    game.physics.arcade.collide(ball, tiles, helpers.ballCollideWithTiles, nullm this);
  }
}
